...
const DispatchForm = () => {
  ...
  useEffect(() => {
    ...
    axios.get('http://localhost:4000/api/lots/status/dispatch')
      .then(response => {
        setLots(response.data);
        console.log("Check Dispatch Data", response.data);
      })
      .catch(error => console.error('Error fetching lot status dispatch data:', error));
  }, []);
  ...
  const validateInput = () => {
    if (dispatchData.kg < 0 || dispatchData.meter < 0 || dispatchData.roll < 0) {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('http://localhost:4000/api/dispatch', dataToSubmit)
      .then(response => {
  ...
  return (
    <div className="max-w-md mx-auto p-4 bg-white shadow-md rounded">
      ...
      <h2 className="text-xl font-semibold mb-4">Dispatch Form</h2>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col items-center">
        <div className="border-2 w-full sm:w-[500px] h-full rounded-lg mt-6 shadow-sm shadow-darkgray">
          <label className="block text-lg font-login ml-4 mt-4 text-gray-700" htmlFor="lotNumber">Lot Number <span className="text-red-600 ml-1">*</span></label>
          <select
            id="lotNumber"
            name="lotNumber"
        ...
        {dispatchData.lotNumber && (
          <>
            <div className="border-2 w-full sm:w-[500px] h-full rounded-lg mt-6 shadow-sm shadow-darkgray">
              <label className="block text-lg font-login ml-4 mt-4 text-gray-700" htmlFor="party">Party Name<span className="text-red-600">*</span></label>
              <select
                id="party"
                name="party"
            ...
            <div className="border-2 w-full sm:w-[500px] h-full rounded-lg mt-6 shadow-sm shadow-darkgray">
              <label className="block text-lg font-login ml-4 mt-4 text-gray-700" htmlFor="quality">Quality<span className="text-red-600">*</span></label>
              <select
                id="quality"
                name="quality"
            ...
            <div className="border-2 w-full sm:w-[500px] h-full rounded-lg mt-6 shadow-sm shadow-darkgray">
              <label className="block text-lg font-login ml-4 mt-4 text-gray-700" htmlFor="qualityChallanNumber">Quality Challan Number<span className="text-red-600">*</span></label>
              <select
                ...
                {selectedLotDetails.entries && selectedLotDetails.entries.map((entry) => (
            ...
            <div className="border-2 w-full sm:w-[500px] h-full rounded-lg mt-6 shadow-sm shadow-darkgray">
              <label className="block text-lg font-login ml-4 mt-4 text-gray-700" htmlFor="process">Process<span className="text-red-600">*</span></label>
              <select
                id="process"
                name="process"
            ...
            <div className="border-2 w-full sm:w-[500px] h-full rounded-lg mt-6 shadow-sm shadow-darkgray">
              <label className="block text-lg font-login ml-4 mt-4 text-gray-700" htmlFor="shade">Shade<span className="text-red-600">*</span></label>
              <select
                id="shade"
                name="shade"
        ...
        <div className="border-2 w-full sm:w-[500px] h-full rounded-lg mt-6 shadow-sm shadow-darkgray">
          <label className="block text-lg font-login ml-4 mt-4 text-gray-700" htmlFor="karigarName">Karigar Name<span className="text-red-600">*</span></label>
          <input
            id="karigarName"
            name="karigarName"
        ...
        <div className="border-2 w-full sm:w-[500px] h-full rounded-lg mt-6 shadow-sm shadow-darkgray">
          <label className="block text-lg font-login ml-4 mt-4 text-gray-700" htmlFor="kg">KG<span className="text-red-600">*</span></label>
          <input
            id="kg"
            name="kg"
        ...
        <div className="border-2 w-full sm:w-[500px] h-full rounded-lg mt-6 shadow-sm shadow-darkgray">
          <label className="block text-lg font-login ml-4 mt-4 text-gray-700" htmlFor="meter">Meter<span className="text-red-600">*</span></label>
          <input
            id="meter"
            name="meter"
        ...
        <div className="border-2 w-full sm:w-[500px] h-full rounded-lg mt-6 shadow-sm shadow-darkgray">
          <label className="block text-lg font-login ml-4 mt-4 text-gray-700" htmlFor="roll">Roll<span className="text-red-600">*</span></label>
          <input
            id="roll"
            name="roll"
        ...
        <button type="submit" className="inline-flex mt-8 px-12 py-2 text-sm font-medium text-white bg-darkgray rounded-md hover:bg-white hover:text-darkgray outline">Submit</button>
      </form>
    </div>
  );
};
